...
## read in data 
numident <- fread("~mariaosborne-ipums/censoc_weights/data/numident/numident_weights_all_adjusted_final.csv")
dmf <- fread("~mariaosborne-ipums/censoc_weights/data/DMF/dmf_weights_all_adjusted_final.csv")
...
ggsave(validation_mortality_plot, filename = here("figs/mortality_validation_hmd_plot.png"), width = 12, height = 5)
```
